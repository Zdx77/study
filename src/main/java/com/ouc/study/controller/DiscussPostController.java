 ...
 *创建者: zdx
 *创建时间:2021/7/21 20:22
 *描述: TODO
 */

import com.ouc.study.entity.*;
...
public class DiscussPostController implements StudyConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return StudyUtil.getJSONString(403, "你还没有登录！");
        }
        ...
        //报错的情况，将来统一处理
        return StudyUtil.getJSONString(0, "发布成功！");
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        if(commentList != null){
            for(Comment comment : commentList){  // 对帖子的每一条评论
                // 一个评论的VO
                Map<String,Object> commentVo = new HashMap<>(); //回复评论（给评论的评论）
                //评论
