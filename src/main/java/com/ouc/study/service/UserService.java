...
@Service
public class UserService implements StudyConstant {
    @Autowired
...
//        return userMapper.selectById(id);
    ...
    public Map<String ,Object> register(User user){
        ...
        user.setPassword(StudyUtil.md5(user.getPassword()+user.getSalt()));
        user.setType(0);
        user.setStatus(0);
        user.setActivationCode(StudyUtil.generateUUID());
    ...
    public Map<String,Object> login(String username,String password,int expiredSeconds){
        ...
        // 验证密码
        password = StudyUtil.md5(password + user.getSalt());
        ...
        loginTicket.setTicket(StudyUtil.generateUUID());
...
//        return userMapper.updateHeader(userId,headerUrl);
    ...
    //2.取不到时初始化缓存数据
    private User inintCache(int userId){
        User user = userMapper.selectById(userId);
        String redisKey = RedisKeyUtil.getUserKey(userId);
